import { FeatureSectionProps } from "@/interfaces/feature.section.interface";

function getIcon(name: string) {
  switch (name) {
    case "CLOCK_ICON":
      return <ClockIcon className="w-12 h-12 mb-10 text-gray-900" />;
    case "CHECK_ICON":
...
export function FeatureSection(props: Props) {
  const {
    data: { feature },
  } = props;
...
function CheckIcon(props: any) {
  return (
    <svg
      // props es la classname qu se le pasa
      {...props}
